...
function Navbar() {
  ...
  return (
    <div
      className={`drawer ${
        color ? " backdrop-blur-md" : "bg-transparent"
      } fixed z-40 `}
    >
      ...
      <div className="drawer-content flex flex-col">
        ...
        <div className="w-full navbar bg-base-300 bg-transparent">
          <div className="flex-1 px-2 mx-2">
            <a href="#home">
              <h1 className="font-bold text-3xl text-white font-mono uppercase shadow-md">
                Giranda
              </h1>
            </a>
          </div>
          <div className="flex-none hidden lg:block">
            <ul className="menu menu-horizontal text-white font-mono">
              ...
              <li className="hover:text-secondary hover:-translate-y-1 duration-75">
                <a href="#home">Home</a>
              </li>
              <li className="hover:text-secondary hover:-translate-y-1 duration-75">
